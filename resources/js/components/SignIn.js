...
function SignIn() {
  ...
  const [formInfo, setFormInfo] = useState({ remember: false });
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    if ((formInfo?.password && formInfo.password !== '') && (formInfo?.email && formInfo.email !== '')) {
      try {
        let req = await axiosUser.post('/login', {
        ...
        setFormError({ error: error.data.message });
          ...
          <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            <form>
              <div className="d-flex flex-row align-items-center justify-content-center justify-content-lg-start mb-5">
                <h1 className="lead fw-normal mb-0 mx-auto fw-bold">Sign in</h1>
              </div>
              ...
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="form-check mb-0">
                  ...
                  <input className="form-check-input me-2" onChange={handleChange} type="checkbox" name="remember" />
                </div>
              ...
              <p className="small mt-2 pt-1 mb-0 text-center">
                Don't have an account? <NavLink className="link-dark" to='sign-up' >Register</NavLink>
              </p>
            </form>
          </div>
        </div>
